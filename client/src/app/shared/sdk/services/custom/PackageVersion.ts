...
export class PackageVersionApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public createFile(id: any, data: any = {}): Observable<any> {
   ...
   * </em>
   */
  public updateFile(id: any, data: any = {}): Observable<any> {
   ...
   */
  public destroyFile(id: any): Observable<any> {
   ...
   * </em>
   */
  public createManyFile(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PackageVersions/:id/file";
    let _routeParams: any = {
